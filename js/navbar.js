                ...
                <div class="group relative">
                    ...
                    <div class="absolute right-0 top-0 pt-12 w-48 origin-top-right invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-200 z-50">
                        <div class="rounded-xl bg-white dark:bg-slate-800 p-2 shadow-xl ring-1 ring-slate-200 dark:ring-slate-700">
                            <a href="profile.html" class="nav-link flex items-center gap-2 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-primary/10 hover:text-primary rounded-lg transition-colors">
                                <span class="material-symbols-outlined text-[18px]">account_circle</span> Profile
                            </a>
                            ${isAdminUser ? `<a href="admin.html" class="nav-link flex items-center gap-2 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-primary/10 hover:text-primary rounded-lg transition-colors"><span class="material-symbols-outlined text-[18px]">dashboard</span> Admin Hub</a>` : ''}
